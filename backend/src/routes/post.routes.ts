...
postRouter.get('/user', authVerify, PostController.getPostsByUser);
postRouter.get('/u/:username', authVerify, PostController.getPostsByUsername);
postRouter.get('/:postId', authVerify, PostController.getPostById);
