  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-between p-4 pb-3">
        <div className="flex items-center space-x-3 min-w-0 flex-1">
          ...
          <div className="relative flex-shrink-0">
            <div className={`w-11 h-11 rounded-full overflow-hidden border-2 transition-all duration-200 ${
              isDarkMode ? "border-gray-700 group-hover:border-gray-600" : "border-gray-200 group-hover:border-gray-300"
            }`}>
                <Image
        ...
        <div className="relative">
          <button 
            ...
            className={`p-2 rounded-full transition-all duration-200 ${
              isDarkMode ? "hover:bg-gray-800 active:bg-gray-700" : "hover:bg-gray-100 active:bg-gray-200"
            }`}
          ...
          {/* Share Menu */}
          {showShareMenu && (
            <div className={`absolute right-0 top-12 w-40 py-2 rounded-xl shadow-lg z-10 ${
            ...
            <div className="absolute bottom-4 right-4 flex items-center space-x-2">
              <button
                ...
                className={`p-2 rounded-full backdrop-blur-sm transition-all duration-200 ${
                  isDarkMode ? "bg-black/60 text-white hover:bg-black/80" : "bg-white/80 text-black hover:bg-white/90"
                }`}
      ...
      <div className="p-4">
        ...
        {/* Comments Preview */}
        {commentCount > 0 && (
          <button className={`text-sm mb-3 block transition-colors ${
            isDarkMode ? "text-gray-400 hover:text-gray-300" : "text-gray-500 hover:text-gray-700"
          }`}>
